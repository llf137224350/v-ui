...
webpackJsonp([4], { "/yaV": function yaV(t, o, a) {
    ...
    Object.defineProperty(o, "__esModule", { value: !0 });var s = a("7+uW"),
        ...
        p = a("34KM"),
        f = (a.n(p), a("tb/R")),
        g = (a.n(f), a("xhZc"));a.n(g);s.a.use(i.a), s.a.use(n.a), s.a.use(c.a);var v = [{ path: "*", component: l.a }, { path: "/goods/:id", component: l.a }, { path: "/goodsDetail/:id", component: u.a }, { path: "/goodsComment/:id", component: h.a }],
        m = new i.a({ routes: v });new s.a({ template: "<GoodsDetail/>", components: { GoodsDetail: d.a }, store: e.a, router: m, data: { eventHub: new s.a() } }).$mount("#app");
...
//# sourceMappingURL=goodsDetail.e8ab710a380a7ddf7496.js.map
//# sourceMappingURL=goodsDetail.e8ab710a380a7ddf7496.js.map