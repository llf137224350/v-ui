...
webpackJsonp([1], { "/yaV": function yaV(t, s, o) {
    ...
    var a = o("fwGr"),
        ...
        var t = this;window.addEventListener("popstate", function (s) {
          ...
          s && -1 != s.indexOf("成功") ? (t.$refs.icontoast.show("支付成功！"), setTimeout(function () {
            ...
            return [];
          } }, count: { type: Number, default: 1 } }, components: { appbar: a.a, progressbar: n.a, popupwindow: d.a, toast: r.a, choiceAddress: l.a, icontoast: c.a }, data: function data() {
    ...
    var a = o("43Vb"),
        ...
        var t = this;this.$nextTick(function () {
          "#/" === location.hash ? t.id = t.goodsId : t.id = location.hash.substring(location.hash.lastIndexOf("/") + 1), t.scroll = new e.a(t.$refs.goodCommentWrapper, { click: !0 }), t.getData(t.id);
        });
      }, data: function data() {
        return { scroll: void 0, id: void 0, host: n.a.host, comments: void 0 };
      }, computed: o.i(r.c)(["goodsId"]), methods: { getData: function getData(t) {
          var s = this;this.$refs.progressbar.show("加载中..."), this.$http.jsonp(n.a.host + "/CommentOfGoodsControl/queryCommentOfGoods.do", { params: { getType: "jsonp", goodsId: t }, jsonp: "jsonp" }).then(function (t) {
        ...
        }, imageViewer: function imageViewer(t, s) {
          for (var o = 0; o < t.length; o++) {
            t[o] = this.host + t[o];
          }window.webkit.messageHandlers.imageViewer.postMessage({ index: s, paths: t });
        } } };
...
//# sourceMappingURL=goodsDetail.73515a52d2d48e05f156.js.map
//# sourceMappingURL=goodsDetail.73515a52d2d48e05f156.js.map