...
webpackJsonp([1], { 0: function _(t, e) {}, "2E1j": function E1j(t, e, i) {
    ...
    function a(t) {
      i("SI2V");
        ...
        n = i("VU/8"),
        d = a,
        o = n(s.a, r.a, d, null, null);e.a = o.exports;
    ...
    Object.defineProperty(e, "__esModule", { value: !0 });var a = i("7+uW"),
        ...
        c = i("34KM"),
        u = (i.n(c), i("tb/R")),
        p = (i.n(u), i("xhZc"));i.n(p);a.a.use(s.a), a.a.use(r.a), a.a.use(d.a);var m = [{ path: "*", component: l.a }, { path: "/item/:id", component: l.a }],
        h = new s.a({ routes: m });new a.a({ template: "<photography/>", components: { photography: o.a }, router: h, data: { eventHub: new a.a() } }).$mount("#app");
    ...
    var a = i("mgS3"),
        ...
        r = i.n(s),
        n = i("gsqX"),
        d = i.n(n);e.a = { data: function data() {
        return { host: r.a.host };
      }, props: { swiperData: { type: Array, default: function _default() {
            return [];
          } } }, watch: { swiperData: function swiperData() {
          this.$nextTick(function () {
            new d.a(".swiper-container1", { autoplay: 5e3, direction: "horizontal", loop: !0, lazyLoading: !0, autoplayDisableOnInteraction: !1, pagination: ".swiper-pagination1", onTap: function onTap(t, e) {} });
          });
        } } };
    ...
    var a = function a() {
      var t = this,
        ...
        return i("div", { staticClass: "swiper-slide swiper-lazy", style: { "background-size": "cover" }, attrs: { "data-background": t.host + e.imgUrl } }, [i("div", { staticClass: "swiper-lazy-preloader" })]);
...
//# sourceMappingURL=photography.e8d2fc4e878bcc18aa33.js.map
//# sourceMappingURL=photography.e8d2fc4e878bcc18aa33.js.map