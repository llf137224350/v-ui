...
webpackJsonp([1], { "/yaV": function yaV(t, s, o) {
    ...
    var a = o("fwGr"),
        ...
        }), this.selfCount = this.count;var s = localStorage.getItem("u");s && (this.userInfo = JSON.parse(s).data);for (var o = 0; o < this.userInfo.deliveries.length; o++) {
        ...
        return { host: i.a.host, orderConfirmShow: !1, userInfo: void 0, selfCount: 1, name: "", phone: "", address: "", deliveryId: "", params: "" };
          ...
          var t = this;this.$refs.progressbar.show("提交订单中...");var s = i.a.host + "/OrderOfGoodsControl/saveOrderOfGoods.do";this.$http.jsonp(s, { params: { getType: "jsonp", token: this.userInfo.memberDetail.safeCode, deliveryName: this.name, deliveryPhone: this.phone, deliveryAddress: this.address, goodsId: this.goods.goodsId, goodsPrice: this.goods.goodsPrice * this.selfCount, goodsCount: this.selfCount, goodsParam: this.params, cartIds: "", isCart: "0", cartCount: "" }, jsonp: "jsonp" }).then(function (s) {
            t.$refs.progressbar.hide(), console.log(JSON.parse(s.bodyText).data), 0 === JSON.parse(s.bodyText).errorCode ? t.$refs.popupwindow.show([{ text: "<div class='pay-item'><i class='wx-logo'></i>　微信支付</div>", callBack: function callBack() {
                t.choiceShow = !1;
        ...
        } }, watch: { selected: function selected() {
    ...
    "use strict";
    var a = o("7+uW"),
        e = o("NYxO");a.a.use(e.a);var i = { photographyId: 0, photographyName: "", photographyTeamId: 0, weddingDressId: 0, goodsId: 0, goods: {}, cameramanId: void 0, cameramanTypeId: void 0 },
    ...
    function a(t) {
      o("4oQO");
        ...
        r = a,
        c = n(e.a, i.a, r, null, null);s.a = c.exports;
  }, "Sd/g": function SdG(t, s) {}, Se33: function Se33(t, s) {}, VA65: function VA65(t, s, o) {
    "use strict";
    var a = function a() {
      var t = this,
          s = t.$createElement,
    ...
    var a = function a() {
      var t = this,
        ...
        e = [],
        i = { render: a, staticRenderFns: e };s.a = i;
  }, l3S6: function l3S6(t, s) {}, mgS3: function mgS3(t, s) {}, ocLB: function ocLB(t, s, o) {
    "use strict";
    var a = function a() {
      var t = this,
          s = t.$createElement,
...
//# sourceMappingURL=goodsDetail.c4fb4f68919789a6904b.js.map
//# sourceMappingURL=goodsDetail.c4fb4f68919789a6904b.js.map