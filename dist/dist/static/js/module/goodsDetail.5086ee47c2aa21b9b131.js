...
webpackJsonp([1], { "/yaV": function yaV(t, s, a) {
    "use strict";
    var o = function o() {
      var t = this,
          s = t.$createElement,
          a = t._self._c || s;return a("div", { ref: "goodCommentWrapper", staticClass: "goods-comment" }, [a("ul", { staticClass: "goods-comment-container" }, t._l(t.comments, function (s) {
        return a("li", { staticClass: "comment-item border-1px" }, [a("div", { staticClass: "comment-top" }, [a("i", { staticClass: "comment-head-pic", style: { background: "url(" + t.host + s.memberDetail.memberPic + ") no-repeat", "background-size": "contain" } }), t._v(" "), a("span", { staticClass: "comment-name" }, [t._v(t._s(s.memberDetail.pickName.substring(0, 1)) + "***" + t._s(s.memberDetail.pickName.substring(s.memberDetail.pickName.length - 1)))]), t._v(" "), a("span", { staticClass: "comment-date" }, [t._v(t._s(s.commentOfGoodsTime.substring(0, s.commentOfGoodsTime.indexOf(" "))))])]), t._v(" "), a("div", { staticClass: "comment-content" }, [t._v("\n                " + t._s(s.commentOfGoodsText) + "\n            ")]), t._v(" "), a("div", { staticClass: "img-container" }, t._l(s.commentOfGoodsImgUrl.split(";"), function (s) {
          return a("img", { staticClass: "img", attrs: { src: "" + t.host + s } });
        }))]);
      })), t._v(" "), a("progressbar", { ref: "progressbar" })], 1);
    },
        e = [],
        i = { render: o, staticRenderFns: e };s.a = i;
  }, 0: function _(t, s) {}, "0LJ2": function LJ2(t, s, a) {
    "use strict";
    var o = a("fwGr"),
        e = a("W/7t"),
        i = a.n(e),
        ...
        r = a("qVA6"),
        c = a("a6ll"),
        d = a("JK1x");s.a = { created: function created() {
        ...
        });var s = localStorage.getItem("u");s && (this.userInfo = JSON.parse(s).data);for (var a = 0; a < this.userInfo.deliveries.length; a++) {
          1 === parseInt(this.userInfo.deliveries[a].deliveryStatus) && (this.name = this.userInfo.deliveries[a].deliveryName, this.phone = this.userInfo.deliveries[a].deliveryPhone, this.address = this.userInfo.deliveries[a].deliveryAddress, this.deliveryId = this.userInfo.deliveries[a].deliveryId);
        }
      }, props: { goods: { type: Object, default: function _default() {
            return {};
          } }, selected: { type: Array, default: function _default() {
            return [];
          } }, count: { type: Number, default: 1 } }, components: { appbar: o.a, progressbar: n.a, popupwindow: c.a, toast: r.a, choiceAddress: d.a }, data: function data() {
    ...
    var o = a("bOdI"),
        ...
        c = a.n(r),
        d = a("NYxO"),
        l = a("PVO9");s.a = { components: { progressbar: l.a }, created: function created() {
  ...
  }, "34KM": function KM(t, s) {}, "4oQO": function oQO(t, s) {}, "58y8": function y8(t, s, a) {
    "use strict";
    var o = a("43Vb"),
        e = a.n(o),
        i = a("W/7t"),
        n = a.n(i),
        r = a("NYxO"),
        c = a("PVO9");s.a = { components: { progressbar: c.a }, created: function created() {
        var t = this;this.$nextTick(function () {
  ...
  }, "5sfs": function sfs(t, s, a) {
    "use strict";
    var o = function o() {
      var t = this,
          s = t.$createElement,
          a = t._self._c || s;return a("div", { staticClass: "choice-address" }, [a("transition", { attrs: { "enter-active-class": "animated fadeIn", "leave-active-class": "animated fadeOut" } }, [a("div", { directives: [{ name: "show", rawName: "v-show", value: t.choiceAddressShow, expression: "choiceAddressShow" }], staticClass: "choice-address-container" }, [a("div", { staticClass: "appbar" }, [a("appbar", { attrs: { color: "#fff", haveMenu: !1, vtitle: "选择收货地址" }, on: { appbarLeftClick: t.appbarLeftClick } })], 1), t._v(" "), a("ul", { staticClass: "choice-address-content" }, t._l(t.userInfo.deliveries, function (s, o) {
        return a("li", { staticClass: "address-item border-1px", on: { click: function click(s) {
              t.address(o);
            } } }, [a("div", [a("span", [t._v(t._s(s.deliveryName))]), a("span", [t._v(" " + t._s(s.deliveryPhone))])]), t._v(" "), a("div", [t._v("收货地址:" + t._s(s.deliveryAddress))])]);
      })), t._v(" "), a("div", { staticClass: "buy-goods-bottom", on: { click: t.goAddressManager } }, [t._v("\n                收货地址管理\n            ")])])])], 1);
    },
        e = [],
        i = { render: o, staticRenderFns: e };s.a = i;
  }, "6YGx": function YGx(t, s, a) {
    "use strict";
    function o(t) {
      a("Se33");
    }var e = a("0LJ2"),
        ...
        r = o,
        c = n(e.a, i.a, r, null, null);s.a = c.exports;
  }, "6axR": function axR(t, s, a) {
    "use strict";
    Object.defineProperty(s, "__esModule", { value: !0 });var o = a("7+uW"),
        e = a("Bh5c"),
        i = a("/ocq"),
        n = a("ORbq"),
        r = a("qJdI"),
        ...
        v = a("34KM"),
        m = (a.n(v), a("tb/R")),
        g = (a.n(m), a("xhZc"));a.n(g);o.a.use(i.a), o.a.use(n.a), o.a.use(c.a), o.a.use(l.a);var w = [{ path: "*", component: h.a }, { path: "/goods/:id", component: h.a }, { path: "/goodsDetail/:id", component: p.a }, { path: "/goodsComment/:id", component: f.a }],
        C = new i.a({ routes: w });new o.a({ template: "<GoodsDetail/>", components: { GoodsDetail: u.a }, store: e.a, router: C, data: { eventHub: new o.a() } }).$mount("#app");
  }, "768o": function o(t, s, a) {
    "use strict";
    function o(t) {
      a("g3tJ");
    }var e = a("Ci1U"),
        ...
        r = o,
        c = n(e.a, i.a, r, null, null);s.a = c.exports;
  }, "7EGo": function EGo(t, s) {}, "8eWd": function eWd(t, s, a) {
    "use strict";
    var o = function o() {
      var t = this,
          s = t.$createElement,
          a = t._self._c || s;return a("div", { ref: "tablayoutHook", staticClass: "tablayout" }, [a("ul", { staticClass: "tablayout-wrapper border-1px", style: { width: t.totalWidth + "px" } }, [t._l(t.datas, function (s, o) {
        return a("li", { staticClass: " tablayout-item", style: { width: t.itemWidth + "px" } }, [a("router-link", { class: { active: o === t.cIndex }, style: { color: o === t.cIndex ? t.color + " !important" : t.normalColor + " !important" }, attrs: { to: s.to, tag: "a" }, domProps: { innerHTML: t._s(s.text) } })], 1);
    ...
    var o = a("Dd8w"),
        ...
        u = a.n(l),
        h = a("PVO9"),
        p = a("NYxO");s.a = { components: { progressbar: h.a }, created: function created() {
        var t = this;this.$nextTick(function () {
    ...
    "use strict";
    var o = a("7+uW"),
        e = a("NYxO");o.a.use(e.a);var i = { photographyId: 0, photographyName: "", photographyTeamId: 0, weddingDressId: 0, goodsId: 0, goods: {}, cameramanId: void 0, cameramanTypeId: void 0 },
  ...
  }, Ci1U: function Ci1U(t, s, a) {
    "use strict";
    var o = a("fwGr"),
        e = a("6YGx"),
        i = a("W/7t"),
        n = a.n(i);s.a = { created: function created() {
        var t = this;window.addEventListener("popstate", function (s) {
          "#/target=buyGoods" != location.hash && "#target=buyGoods" != location.hash && (t.buyGoodsShow = !1);
        });
      }, props: { goods: { type: Object, default: function _default() {
            return {};
          } } }, components: { appbar: o.a, ConfirmationOfOrder: e.a }, data: function data() {
        return { host: n.a.host, buyGoodsShow: !1, count: 1, selected: [] };
          ...
          this.selected = [];for (var s = 0; s < this.goods.goodsParamList.length; s++) {
            if (this.selected.push([]), this.goods.goodsParamList[s].paramValue.indexOf(";")) for (var a = this.goods.goodsParamList[s].paramValue.split(";"), o = 0; o < a.length; o++) {
              this.selected[s][o] = o === t ? 1 : 0;
            } else this.selected[s].push(1);
          }
        } }, watch: { goods: function goods() {
          this.setSize(0);
        } } };
  }, DN9l: function DN9l(t, s) {}, DR4q: function DR4q(t, s, a) {
    "use strict";
    function o(t) {
      a("rMU2");
    }var e = a("16H1"),
  ...
  }, L0fE: function L0fE(t, s, a) {
    "use strict";
    var o = function o() {
      var t = this,
          s = t.$createElement,
          a = t._self._c || s;return a("div", { staticClass: "toast" }, [a("transition", { attrs: { name: "fade" } }, [a("div", { directives: [{ name: "show", rawName: "v-show", value: t.isShow, expression: "isShow" }], staticClass: "content" }, [t._v(t._s(t.content))])])], 1);
    },
        e = [],
        i = { render: o, staticRenderFns: e };s.a = i;
  }, NNzt: function NNzt(t, s, a) {
    "use strict";
    s.a = { data: function data() {
    ...
    function o(t) {
      a("4oQO");
        ...
        r = o,
        c = n(e.a, i.a, r, null, null);s.a = c.exports;
  }, "Sd/g": function SdG(t, s) {}, Se33: function Se33(t, s) {}, VA65: function VA65(t, s, a) {
    "use strict";
    var o = function o() {
      var t = this,
          s = t.$createElement,
          a = t._self._c || s;return a("div", { ref: "goodDetailWrapper", staticClass: "goods-detail1" }, [a("div", { staticClass: "goods-detail-container" }, t._l(t.goods && t.goods.goodsDetail.split(";"), function (s) {
        return t.goods ? a("img", { attrs: { src: t.host + "/" + s, width: "100%", height: "100%" } }) : t._e();
      })), t._v(" "), a("progressbar", { ref: "progressbar" })], 1);
    },
        e = [],
        i = { render: o, staticRenderFns: e };s.a = i;
  }, VCEL: function VCEL(t, s, a) {
    "use strict";
    var o = a("fwGr"),
        e = a("NYxO"),
        i = a("PVO9"),
        n = a("W/7t"),
        r = a.n(n),
        c = a("z+5l");s.a = { computed: a.i(e.c)(["goods"]), created: function created() {
        var t = this;window.addEventListener("popstate", function (s) {
          t.isShow = !1;
        });
      }, components: { appbar: o.a, progressbar: i.a, icontoast: c.a }, data: function data() {
        return { count: 1, isShow: !1, isOk: !1, host: r.a.host, sizeIndex: 0, userInfo: void 0, selected: [], params: "" };
          ...
          var t = this;if (this.isOk) {
            var s = localStorage.getItem("u");s ? (this.userInfo = JSON.parse(s).data, this.$refs.progressbar.show("添加中..."), this.$http.jsonp(r.a.host + "/CartInfoControl/saveCartInfo.do", { params: { getType: "jsonp", goodsCount: this.count, goodsId: this.goods.goodsId, token: this.userInfo.memberDetail.safeCode, goodsParam: this.params }, jsonp: "jsonp" }).then(function (s) {
              t.$refs.progressbar.hide();var a = JSON.parse(s.bodyText);0 === parseInt(a.errorCode) ? t.$refs.icontoast.show("已添加", "succeed") : t.$refs.icontoast.show(a.data, "failed");
            }, function () {
              console.log("请求失败！！！");
  ...
  }, Y54c: function Y54c(t, s, a) {
    "use strict";
    var o = function o() {
      var t = this,
          s = t.$createElement,
          a = t._self._c || s;return a("div", { ref: "goodWrapper", staticClass: "goods" }, [a("div", { staticClass: "goods-container" }, [a("div", { staticClass: "goods-slider" }, [a("div", { staticClass: "swiper-container" }, [a("div", { staticClass: "swiper-wrapper" }, t._l(t.swiperData, function (s) {
        return a("div", { staticClass: "swiper-slide swiper-lazy", style: { "background-size": "cover" }, attrs: { "data-background": t.host + s.goodsSlideUrl } }, [a("div", { staticClass: "swiper-lazy-preloader" })]);
      }))]), t._v(" "), a("span", { staticClass: "indicator" }, [t._v(t._s(t.currentIndex) + "/" + t._s(t.swiperData.length))])]), t._v(" "), a("div", { staticClass: "goods-detail" }, [a("div", { staticClass: "simple-des" }, [a("span", { staticClass: "sale-count" }, [t._v("已售" + t._s(t.goods.goodsCount) + "件")]), t._v(" "), a("span", { staticClass: "sale-price" }, [t._v("￥" + t._s(t.goods.goodsPrice))])]), t._v(" "), a("div", { staticClass: "params " }, [a("div", { staticClass: "params-title border-1px" }, [t._v("产品参数/DETAILS")]), t._v(" "), a("div", { staticClass: "params-name border-1px" }, [t._v("产品名称 "), a("span", [t._v(t._s(t.goods.goodsName))])]), t._v(" "), a("div", { staticClass: "params-date border-1px" }, [t._v("上市时间 "), a("span", [t._v(t._s(t.goods.goodsDate))])]), t._v(" "), t._l(t.goods.goodsParamList, function (s) {
        return a("div", { staticClass: "params border-1px" }, [t._v(t._s(s.paramKey) + " "), a("span", [t._v(t._s(s.paramValue))])]);
      })], 2)])]), t._v(" "), a("progressbar", { ref: "progressbar" })], 1);
    },
        e = [],
        i = { render: o, staticRenderFns: e };s.a = i;
  }, YZfL: function YZfL(t, s) {}, a6ll: function a6ll(t, s, a) {
    "use strict";
    function o(t) {
      a("YZfL");
    }var e = a("NNzt"),
        ...
        r = o,
        c = n(e.a, i.a, r, null, null);s.a = c.exports;
  }, aAHY: function aAHY(t, s, a) {
    "use strict";
    var o = function o() {
      var t = this,
          s = t.$createElement,
          a = t._self._c || s;return a("div", { staticClass: "buy-goods" }, [a("transition", { attrs: { "enter-active-class": "animated fadeIn", "leave-active-class": "animated fadeOut" } }, [a("div", { directives: [{ name: "show", rawName: "v-show", value: t.buyGoodsShow, expression: "buyGoodsShow" }], staticClass: "buy-goods-container" }, [a("div", { staticClass: "appbar" }, [a("appbar", { attrs: { color: "#fff", haveMenu: !1, vtitle: "购买商品" }, on: { appbarLeftClick: t.appbarLeftClick } })], 1), t._v(" "), a("div", { directives: [{ name: "show", rawName: "v-show", value: t.goods.goodsName, expression: "goods.goodsName" }], staticClass: "goods-content" }, [a("div", { staticClass: "goods-info border-1px" }, [a("i", { directives: [{ name: "lazy", rawName: "v-lazy:background-image", value: "" + t.host + t.goods.goodsPic, expression: "`${host}${goods.goodsPic}`", arg: "background-image" }], staticClass: "goods-pic" }), t._v(" "), a("div", { staticClass: "goods-des" }, [a("div", { staticClass: "goods-price" }, [t._v("￥" + t._s(t.goods.goodsPrice))]), t._v(" "), a("div", { staticClass: "goods-selected" }, [t._v("请选择　"), t._l(t.goods.goodsParamList, function (s) {
        return a("span", [t._v(t._s(s.paramKey) + " ")]);
      })], 2), t._v(" "), a("div", { staticClass: "buy-goods-count" }, [t._v("\n                            购买数量\n                            "), a("div", { staticClass: "buy-goods-opts" }, [a("span", { on: { click: t.sub } }), a("input", { directives: [{ name: "model", rawName: "v-model", value: t.count, expression: "count" }], attrs: { type: "number", readonly: "readonly" }, domProps: { value: t.count }, on: { input: function input(s) {
            s.target.composing || (t.count = s.target.value);
          } } }), a("span", { staticClass: "add", on: { click: t.add } })])])])]), t._v(" "), a("div", { staticClass: "select-param " }, t._l(t.goods.goodsParamList, function (s, o) {
        return a("div", { staticClass: "param-item border-1px" }, [a("div", { staticClass: "key" }, [t._v(t._s(s.paramKey))]), t._v(" "), a("div", { staticClass: "values" }, [-1 === s.paramValue.indexOf(";") ? a("span", { staticClass: "param-selected" }, [t._v(t._s(s.paramValue))]) : t._e(), t._v(" "), t._l(s.paramValue.split(";"), function (e, i) {
          return -1 != s.paramValue.indexOf(";") ? a("span", { class: { "param-selected": 1 === t.selected[o][i] }, on: { click: function click(s) {
                t.setSize(i);
              } } }, [t._v(t._s(e))]) : t._e();
        })], 2)]);
      }))]), t._v(" "), a("div", { staticClass: "buy-goods-bottom", on: { click: t.order } }, [t._v("\n                确定\n            ")])])]), t._v(" "), a("ConfirmationOfOrder", { ref: "ConfirmationOfOrder", attrs: { goods: t.goods, selected: t.selected, count: t.count } })], 1);
    },
        e = [],
        i = { render: o, staticRenderFns: e };s.a = i;
    ...
    function o(t) {
      a("Sd/g");
        ...
        r = o,
        c = n(e.a, i.a, r, null, null);s.a = c.exports;
  }, g3tJ: function g3tJ(t, s) {}, hAVC: function hAVC(t, s) {}, iDor: function iDor(t, s) {}, kBKX: function kBKX(t, s, a) {
    "use strict";
    s.a = { data: function data() {
    ...
    var o = function o() {
      var t = this,
        ...
        e = [],
        i = { render: o, staticRenderFns: e };s.a = i;
  }, pQLe: function pQLe(t, s) {}, qSQl: function qSQl(t, s, a) {
    "use strict";
    var o = a("fwGr");s.a = { created: function created() {
        var t = this;window.addEventListener("popstate", function (s) {
      ...
      }, components: { appbar: o.a }, data: function data() {
    ...
    function o(t) {
      a("l3S6");
        ...
        r = o,
        c = n(e.a, i.a, r, null, null);s.a = c.exports;
  }, rMU2: function rMU2(t, s) {}, sA7G: function sA7G(t, s, a) {
    "use strict";
    var o = function o() {
      var t = this,
          s = t.$createElement,
          a = t._self._c || s;return a("div", { staticClass: "confirm-order" }, [a("transition", { attrs: { "enter-active-class": "animated fadeIn", "leave-active-class": "animated fadeOut" } }, [a("div", { directives: [{ name: "show", rawName: "v-show", value: t.orderConfirmShow, expression: "orderConfirmShow" }], staticClass: "confirm-order-container" }, [a("div", { staticClass: "appbar" }, [a("appbar", { attrs: { color: "#fff", haveMenu: !1, vtitle: "确认订单" }, on: { appbarLeftClick: t.appbarLeftClick } })], 1), t._v(" "), a("div", { staticClass: "goods-content" }, [a("div", { staticClass: "address-info", on: { click: t.choiceAddress } }, [a("i", { staticClass: "address-icon" }), t._v(" "), a("div", { staticClass: "address-content" }, [a("div", [a("span", [t._v(t._s(t.name))]), a("span", [t._v(" " + t._s(t.phone))])]), t._v(" "), a("div", [t._v("收货地址:" + t._s(t.address))]), t._v(" "), a("i", { staticClass: "arrow" })])]), t._v(" "), a("div", { staticClass: "goods-info border-1px" }, [a("i", { directives: [{ name: "lazy", rawName: "v-lazy:background-image", value: "" + t.host + t.goods.goodsPic, expression: "`${host}${goods.goodsPic}`", arg: "background-image" }], staticClass: "goods-pic" }), t._v(" "), a("div", { staticClass: "goods-des" }, [a("div", { staticClass: "goods-name" }, [t._v(t._s(t.goods.goodsName))]), t._v(" "), a("div", { staticClass: "goods-price" }, [t._v("￥" + t._s(t.goods.goodsPrice))]), t._v(" "), a("div", { staticClass: "goods-selected" }, [t._v("\n                            " + t._s(t.params) + "\n                        ")]), t._v(" "), a("div", { staticClass: "confirm-order-count" }, [t._v("\n                            购买数量\n                            "), a("div", { staticClass: "confirm-order-opts" }, [a("span", { on: { click: t.sub } }), a("input", { directives: [{ name: "model", rawName: "v-model", value: t.selfCount, expression: "selfCount" }], attrs: { type: "number", readonly: "readonly" }, domProps: { value: t.selfCount }, on: { input: function input(s) {
            s.target.composing || (t.selfCount = s.target.value);
          } } }), a("span", { staticClass: "add", on: { click: t.add } })])])])])]), t._v(" "), a("div", { staticClass: "price-total border-1px" }, [a("div", { staticClass: "result" }, [t._v("合计:"), a("span", { staticClass: "total-price" }, [t._v("￥" + t._s(t.selfCount * t.goods.goodsPrice))]), a("span", { staticClass: "do", on: { click: t.doSubmit } }, [t._v("提交订单")])])])])]), t._v(" "), a("progressbar", { ref: "progressbar" }), t._v(" "), a("toast", { ref: "toast" }), t._v(" "), a("popupwindow", { ref: "popupwindow", on: { cancel: t.cancel } }), t._v(" "), a("choiceAddress", { ref: "choiceAddress", on: { choiceAddressCallback: t.choiceAddressCallback } })], 1);
    },
        e = [],
        i = { render: o, staticRenderFns: e };s.a = i;
  }, tSSn: function tSSn(t, s) {}, "tb/R": function tbR(t, s) {}, uGOo: function uGOo(t, s) {}, vXxv: function vXxv(t, s, a) {
    "use strict";
    var o = function o() {
      var t = this,
          s = t.$createElement,
    ...
    var o = a("Dd8w"),
        ...
        u = a("IICd"),
        h = a("768o"),
        p = a("NYxO");s.a = { computed: a.i(p.c)(["goods"]), components: { appbar: i.a, tablayout: n.a, progressbar: d.a, icontoast: l.a, addcart: u.a, buyGoods: h.a }, created: function created() {
        var t = this,
            s = new RegExp(/\?id=(\d+)&name=(\S+)/),
            a = decodeURIComponent(location.search).match(s);this.id = a[1], this.title = a[2] + " 详情", this.setGoodsId(this.id), this.$nextTick(function () {
        ...
        return { id: "", title: "", tabDatas: [{ text: "", to: "" }], count: 1, host: c.a.host, userInfo: void 0 };
      }, methods: e()({}, a.i(p.b)(["setGoodsId"]), { appbarLeftClick: function appbarLeftClick() {
          ...
          var t = this,
            ...
            t.$refs.progressbar.hide();var a = JSON.parse(s.bodyText);0 === parseInt(a.errorCode) ? t.$refs.icontoast.show(a.data, "succeed") : t.$refs.icontoast.show(a.data, "failed");
          }, function () {
            console.log("请求失败！！！");
          });
...
//# sourceMappingURL=goodsDetail.5086ee47c2aa21b9b131.js.map
//# sourceMappingURL=goodsDetail.5086ee47c2aa21b9b131.js.map