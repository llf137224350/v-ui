...
webpackJsonp([6], { "+NMY": function NMY(t, s, e) {
    ...
    var a = function a() {
      var t = this,
          s = t.$createElement,
          e = t._self._c || s;return e("div", { attrs: { id: "app" } }, [e("div", { staticClass: "appbar-container" }, [e("appbar", { attrs: { vtitle: "管理收获地址", color: "#fff", haveMenu: !1 }, on: { appbarLeftClick: t.appbarLeftClick } })], 1), t._v(" "), e("div", { ref: "addressWrapper", staticClass: "address-wrapper" }, [e("div", [e("ul", { directives: [{ name: "show", rawName: "v-show", value: this.userInfo.deliveries && this.userInfo.deliveries.length > 0, expression: "this.userInfo.deliveries && this.userInfo.deliveries.length > 0" }] }, t._l(this.userInfo.deliveries, function (s, a) {
        return e("li", { staticClass: "address-item border-1px" }, [e("div", { staticClass: "address-top border-1px" }, [e("div", { staticClass: "addressNameAndPhone" }, [e("span", [t._v(t._s(s.deliveryName))]), t._v(" "), e("span", [t._v(t._s(s.deliveryPhone))])]), t._v(" "), e("div", { staticClass: "address" }, [t._v("\n             " + t._s(s.deliveryAddress) + "\n           ")])]), t._v(" "), e("div", { staticClass: "address-bottom" }, [e("i", { class: { default: 1 === s.deliveryStatus } }), t._v(" "), e("span", { staticClass: "default-address" }, [t._v("默认地址")]), t._v(" "), e("div", { staticClass: "address-options" }, [e("span", [t._v("编辑")]), t._v(" "), e("span", { on: { click: function click(e) {
              t.deleteAddress(s.deliveryId, a);
            } } }, [t._v("删除")])])])]);
      }))])]), t._v(" "), e("div", { directives: [{ name: "show", rawName: "v-show", value: !this.userInfo.deliveries || 0 === this.userInfo.deliveries.length, expression: "!this.userInfo.deliveries || this.userInfo.deliveries.length === 0" }] }, [e("transition", { attrs: { "enter-active-class": "animated fadeIn ", "leave-active-class": "animated fadeOut " } }, [e("div", { staticClass: "address-empty" }, [e("i"), t._v(" "), e("span", [t._v("还没有收货地址哦")])])])], 1), t._v(" "), e("div", { staticClass: "add-address" }, [t._v("\n    添加收货地址\n  ")]), t._v(" "), e("progressbar", { ref: "progressbar" }), t._v(" "), e("confirmdialog", { ref: "confirm" }), t._v(" "), e("icontoast", { ref: "toast" })], 1);
    },
        i = [],
        n = { render: a, staticRenderFns: i };s.a = n;
    ...
    var a = function a() {
      var t = this,
          s = t.$createElement,
          e = t._self._c || s;return e("div", { staticClass: "confirm" }, [e("transition", { attrs: { "enter-active-class": "animated fadeIn ", "leave-active-class": "animated fadeOut " } }, [e("div", { directives: [{ name: "show", rawName: "v-show", value: t.isShow, expression: "isShow" }], staticClass: "confirm-mask" })]), t._v(" "), e("transition", { attrs: { "enter-active-class": "animated zoomIn ", "leave-active-class": "animated zoomOut " }, on: { "after-leave": t.afterLeave } }, [e("div", { directives: [{ name: "show", rawName: "v-show", value: t.isShow, expression: "isShow" }], ref: "hook", staticClass: "confirm-content-wrapper" }, [e("div", { staticClass: "content" }, [t._v("\n        " + t._s(t.content) + "\n      ")]), t._v(" "), e("div", { staticClass: "btn" }, [e("div", { staticClass: "cancel", on: { click: t.hide } }, [t._v(t._s(t.cancelText))]), t._v(" "), e("div", { staticClass: "ok", on: { click: t.okHide } }, [t._v(t._s(t.okText))])])])])], 1);
    },
        i = [],
        n = { render: a, staticRenderFns: i };s.a = n;
    ...
    Object.defineProperty(s, "__esModule", { value: !0 });var a = e("7+uW"),
        ...
        c = e("34KM"),
        l = (e.n(c), e("tb/R")),
        d = (e.n(l), e("xhZc"));e.n(d);a.a.use(i.a), a.a.use(o.a), new a.a({ template: "<deliveryAddress/>", components: { deliveryAddress: r.a }, data: { eventHub: new a.a() } }).$mount("#app");
    ...
    var a = e("mvHQ"),
        ...
        return { host: d.a.host, userInfo: void 0 };
          ...
          var e = this;console.log(s), this.$refs.confirm.show("确定要删除吗？", function () {
            e.$refs.progressbar.show("删除中..."), e.$http.jsonp(d.a.host + "/DeliveryControl/deleteDelivery.do", { params: { getType: "jsonp", deliveryId: t }, jsonp: "jsonp" }).then(function (t) {
              e.$refs.progressbar.hide();var a = JSON.parse(t.bodyText);if (console.log(a), 0 === parseInt(a.errorCode)) {
                e.$refs.toast.show(a.data, "succeed");var n = localStorage.getItem("u");n && (n = JSON.parse(n), n.data.deliveries.splice(s, 1), e.userInfo = n.data, localStorage.setItem("u", i()(n)));
              } else e.$refs.toast.show(a.data, "failed");
            }, function () {
              console.log("请求失败！！！");
            });
          });
...
//# sourceMappingURL=deliveryAddress.22e7f263e5edcdb742c6.js.map
//# sourceMappingURL=deliveryAddress.22e7f263e5edcdb742c6.js.map