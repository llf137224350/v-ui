...
require('common/stylus/index1.styl');
...
var routes = [{ path: '*', component: _goods2.default, redirect: '/seller' }, { path: '/seller', component: _seller2.default }, { path: '/ratings', component: _ratings2.default }, { path: '/item/:id', component: _item2.default }];
// 创建路由
