...
webpackJsonp([0], { "+4IP": function IP(t, e, i) {
    ...
    function s(t) {
      i("iA3U");
        ...
        r = s,
        c = o(n.a, a.a, r, null, null);e.a = c.exports;
  }, "9u/O": function uO(t, e) {}, AKNT: function AKNT(t, e, i) {
    "use strict";
    ...
    var s = function s() {
      var t = this,
        ...
        n = [],
        a = { render: s, staticRenderFns: n };e.a = a;
  }, XKY9: function XKY9(t, e) {}, XeJ3: function XeJ3(t, e, i) {
    "use strict";
    ...
    function s(t) {
      i("9u/O");
        ...
        r = s,
        c = o(n.a, a.a, r, null, null);e.a = c.exports;
  }, XfCo: function XfCo(t, e) {}, a6ll: function a6ll(t, e, i) {
    "use strict";
    ...
    e.a = { created: function created() {
        ...
        return { min: 0, max: 100, current: 0, mainWidrh: 0, callBack: void 0, startX: 0, moveX: 0, endX: 0, isRound: !1, react: void 0 };
          ...
          if (t < this.min || t > this.max) return void alert("数据不合法，请检查！");this.current = t, this.move();
        }, setMinValue: function setMinValue(t) {
          this.min = t;
        }, setMaxValue: function setMaxValue(t) {
          this.max = t;
    ...
    function s(t) {
      i("qrCR");
        ...
        r = s,
        c = o(n.a, a.a, r, null, null);e.a = c.exports;
  }, enWY: function enWY(t, e) {}, esg4: function esg4(t, e, i) {
    "use strict";
    ...
    var s = i("tb/R"),
        ...
        g = i("sdEe"),
        C = i("vh/h"),
        y = i("XeJ3");e.a = { created: function created() {
        this.$nextTick(function () {
  ...
  }, rFpO: function rFpO(t, e) {}, sXYI: function sXYI(t, e, i) {
    "use strict";
    ...
    var s = function s() {
      var t = this,
          ...
          i = t._self._c || e;return i("div", { staticClass: "number-keyboard" }, [i("transition", { attrs: { "enter-active-class": "animated slideInUp fadeIn", "leave-active-class": "animated slideOutDown  fadeOut" } }, [i("div", { directives: [{ name: "show", rawName: "v-show", value: t.isShow, expression: "isShow" }], staticClass: "number-keyboard-content-wrapper  border-1px" }, [i("div", { staticClass: "close-keyboard border-1px", on: { click: function click(e) {
            ...
            t.clickHandle(e);
          } } }, [t._v("9")])]), t._v(" "), i("ul", { staticClass: "border1px" }, [i("li", { staticClass: "border-w1px", class: { delete: !t.decimal }, on: { click: function click(e) {
            t.clickHandle(e);
    ...
    function s(t) {
      i("VzWC");
        ...
        r = s,
        c = o(n.a, a.a, r, null, null);e.a = c.exports;
  }, ydn3: function ydn3(t, e) {}, yx3A: function yx3A(t, e, i) {
    "use strict";

    var s = function s() {
      var t = this,
          e = t.$createElement,
          i = t._self._c || e;return i("div", { staticClass: "svideo" }, [i("div", { staticClass: "svideo-title" }, [t._v(t._s(t.title))]), t._v(" "), i("video", { ref: "video", staticClass: "svideo-video", staticStyle: { "object-fit": "fill" }, attrs: { autoplay: t.autoplay, volume: "1", "webkit-playsinline": "true", playsinline: "true", "x5-video-player-type": "h5", "x5-video-orientation": "h5", "x5-video-player-fullscreen": "true", preload: "auto" }, on: { click: t.handleClick, timeupdate: t.timeupdate, ended: t.ended } }, [i("source", { attrs: { src: t.src } })]), t._v(" "), i("i", { directives: [{ name: "show", rawName: "v-show", value: t.playShow, expression: "playShow" }], staticClass: "play-pause", class: { pause: t.isPlay, play: !t.isPlay } }), t._v(" "), i("div", { directives: [{ name: "show", rawName: "v-show", value: t.optShow, expression: "optShow" }], staticClass: "svideo-opt" }, [i("span", { staticClass: "currentTime" }, [t._v(t._s(t.currentTime))]), t._v(" "), i("div", { staticClass: "slider-wrapper" }, [i("slider", { ref: "slide", attrs: { minValue: t.minValue, maxValue: t.maxValue, deviationX: 56 } })], 1), t._v(" "), i("span", { staticClass: "totalTime" }, [t._v(t._s(t.totalTime))]), t._v(" "), i("i", { staticClass: "size fullscreen" })])]);
    },
        n = [],
        a = { render: s, staticRenderFns: n };e.a = a;
  }, "z+5l": function z5l(t, e, i) {
    "use strict";
    ...
    var s = function s() {
      var t = this,
        ...
        n = [],
        a = { render: s, staticRenderFns: n };e.a = a;
  }, zn2t: function zn2t(t, e, i) {
    "use strict";

    var s = i("AbIO"),
        n = void 0,
        a = void 0;e.a = { created: function created() {
        var t = this;this.$nextTick(function () {
          t.optShow = !1, t.video || (t.video = t.$refs.video), t.slide || (t.slide = t.$refs.slide), t.slide.initCallBack(function (e) {
            t.video.currentTime != e && (t.currentTime = t.formatTime(e), t.video.currentTime = e, t.isPlay || (t.video.play(), t.isPlay = !0));
          });
        });
      }, data: function data() {
        return { isPlay: this.autoplay, minValue: 0, maxValue: 0, currentTime: "00:00", totalTime: "00:00", video: void 0, slider: void 0, optShow: !0, playShow: !0 };
      }, components: { slider: s.a }, props: { src: { type: String, default: "" }, title: { type: String, default: "" }, autoplay: { type: Boolean, default: !1 } }, methods: { handleClick: function handleClick(t) {
          var e = this;if (this.isPlay && this.playShow) return this.$refs.video.pause(), this.isPlay = !1, n || clearTimeout(n), void (n = setTimeout(function () {
            e.optShow = !1;
          }, 5e3));if (this.isPlay) {
            if (this.optShow = !0, this.playShow = !0, a || clearTimeout(a), a = setTimeout(function () {
              e.isPlay && (e.optShow = !1, e.playShow = !1);
            }, 5e3), this.isPlay) return;
          } else this.optShow = !1, this.playShow = !1;this.isPlay ? this.$refs.video.pause() : this.$refs.video.play(), this.isPlay = !this.isPlay;
        }, loaded: function loaded() {
          var t = this.video.duration;this.maxValue = t, this.slide.setMaxValue(t), this.totalTime = this.formatTime(t);
        }, timeupdate: function timeupdate() {
          0 === this.maxValue && this.loaded();var t = this.video.currentTime;this.slide.setCurrentValue(t), this.currentTime = this.formatTime(t);
        }, ended: function ended() {
          this.video.pause(), this.video.currentTime = 0, this.currentValue = 0, this.isPlay = !1;
        }, formatTime: function formatTime(t) {
          var e = parseInt(t / 3600),
              i = parseInt(t / 60 % 60),
              s = parseInt(t % 60);return (e > 0 ? (e < 10 ? "0" + e : e) + ":" : "") + (i < 10 ? "0" + i : i) + ":" + (s < 10 ? "0" + s : s);
        } } };
...
//# sourceMappingURL=index1.09a32d2aa8dea3816fae.js.map
//# sourceMappingURL=index1.09a32d2aa8dea3816fae.js.map
//# sourceMappingURL=index1.09a32d2aa8dea3816fae.js.map
