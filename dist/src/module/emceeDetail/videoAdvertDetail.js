...
var _videoWorks = require('components/videoWorks/emceeWorks.vue');

var _videoWorks2 = _interopRequireDefault(_videoWorks);

var _videoDes = require('components/videoDes/emceeDes.vue');
...
new _vue2.default({
  ...
  components: { videoAdvertDetail: _emceeDetail2.default },
