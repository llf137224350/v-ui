...
var _cartOrderConfirm = require('./cartOrderConfirm.vue');

var _cartOrderConfirm2 = _interopRequireDefault(_cartOrderConfirm);
...
new _vue2.default({
  template: '<cartOrderConfirm/>',
  components: { cartOrderConfirm: _cartOrderConfirm2.default },
  data: {
    eventHub: new _vue2.default() // 用于子控件向父控件传递事件  radio需要
  }
}).$mount('#app');
//# sourceMappingURL=cartOrderConfirm.js.map