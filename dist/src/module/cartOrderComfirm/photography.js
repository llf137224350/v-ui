...
var _photography = require('./cartOrderConfirm.vue');

var _photography2 = _interopRequireDefault(_photography);

var _photographyList = require('components/photographyList/photographyList.vue');
...
new _vue2.default({
  ...
  components: { photography: _photography2.default },
