...
var _videoAdvert = require('./videoAdvert.vue');

var _videoAdvert2 = _interopRequireDefault(_videoAdvert);
...
new _vue2.default({
  template: '<videoAdvert/>',
  components: { videoAdvert: _videoAdvert2.default },
  data: {
    eventHub: new _vue2.default() // 用于子控件向父控件传递事件  radio需要
  }
}).$mount('#app');
//# sourceMappingURL=videoAdvert.js.map