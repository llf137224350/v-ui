...
var _weddingplanning = require('./weddingPlanningSet.vue');

var _weddingplanning2 = _interopRequireDefault(_weddingplanning);
...
new _vue2.default({
  template: '<weddingplanning/>',
  components: { weddingplanning: _weddingplanning2.default },
  data: {
