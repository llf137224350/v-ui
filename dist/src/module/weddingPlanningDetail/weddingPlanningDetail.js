...
var _weddingPlanningDetail = require('./weddingPlanningDetail.vue');

var _weddingPlanningDetail2 = _interopRequireDefault(_weddingPlanningDetail);
...
new _vue2.default({
  template: '<weddingPlanningDetail/>',
  components: { weddingPlanningDetail: _weddingPlanningDetail2.default },
  data: {
    eventHub: new _vue2.default() // 用于子控件向父控件传递事件  radio需要
  }
}).$mount('#app');
//# sourceMappingURL=weddingPlanningDetail.js.map