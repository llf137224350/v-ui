...
var _videoAdvertDetail3 = require('components/emcee/videoAdvertDetail.vue');

var _videoAdvertDetail4 = _interopRequireDefault(_videoAdvertDetail3);
...
var routes = [{ path: '*', component: _videoAdvertDetail4.default }, { path: '/emcee/:id', component: _videoAdvertDetail4.default }];
// 创建路由
...
new _vue2.default({
  template: '<emceeList/>',
  components: { emceeList: _videoAdvertDetail2.default },
