...
var _flowerDetail = require('./flowerDetail.vue');

var _flowerDetail2 = _interopRequireDefault(_flowerDetail);
...
new _vue2.default({
  template: '<flowerDetail/>',
  components: { flowerDetail: _flowerDetail2.default },
  data: {
