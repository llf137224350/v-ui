...
var _weddingPlanningSet = require('./weddingPlanningSet.vue');

var _weddingPlanningSet2 = _interopRequireDefault(_weddingPlanningSet);
...
new _vue2.default({
  template: '<weddingPlanningSet/>',
  components: { weddingPlanningSet: _weddingPlanningSet2.default },
  data: {
