...
var _emcee3 = require('components/emcee/emcee.vue');

var _emcee4 = _interopRequireDefault(_emcee3);
...
var routes = [{ path: '*', component: _emcee4.default }, { path: '/emcee/:id', component: _emcee4.default }];
// 创建路由
...
new _vue2.default({
  template: '<emceeList/>',
  components: { emceeList: _emcee2.default },
