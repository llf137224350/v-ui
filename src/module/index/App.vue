  ...
  <div id="app">
    <div ref="appScroll">
      ...
      <div>
        ...
        <datetimepicker ref="datetimepicker" @datetimepickerOkCallBack="datetimepickerOkCallBack"></datetimepicker>
      </div>
      <div>
        <h1>地区选择器</h1>
      ...
      <div style="margin-top: 10px">
        ...
        <h2>品牌</h2>
          ...
          <radio :checked="true" :name="'name'" :value="'IBM'" :label="'IBM'" v-model="radioCheckedValue"></radio>
        ...
        <radio :checked="true" :name="'game'" :value="'消灭星星'" :label="'消灭星星'" v-model="gameCheckedValue"></radio>
        <br/>
        <br/>
