...
<style lang="stylus" rel="stylesheet/stylus" type="text/stylus">
    ...
    .v-loading
        ...
        &.default
            ...
            -webkit-background-size: auto px2rem(20px)
            background-size: auto px2rem(20px)
        ...
        &.white
            ...
            -webkit-background-size: auto px2rem(37px)
            background-size: auto px2rem(37px)
    ...
    @keyframes am-rotate
        ...
        100%
            background-position: px2rem(-240px) 0;

    @keyframes am-rotate-white
        0%
            background-position: 0 0;
        100%
            background-position: px2rem(-444px) 0;
</style>
